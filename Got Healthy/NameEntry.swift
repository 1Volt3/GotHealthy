...
class NameEntry: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        let firstNameInput = FloatingLabelText(frame: CGRect(x: 90, y: 60, width: 250, height: 45))
        ...
        let lastNameInput = FloatingLabelText(frame: CGRect(x: 90, y: 120, width: 250, height: 45))
